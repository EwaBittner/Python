...
class TicTacToe:
    def __init__(self):
        ...
        self.current_winner = None # keep track of a winner
    ...
    def available_moves(self):
        return [i for i , spot in enumerate(self.board) if spot == ' ']  #shorter version
        # moves = []
    ...
    def winner(self, square, letter):
        ...
        # check diagonals
        # nut only if the square is an even number (0,2,4,6,8)
...
def play(game, x_player, o_player, print_game=True):
    ...
    # iterate while the game still has empty aquares
